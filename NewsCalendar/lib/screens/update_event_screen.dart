...
class _UpdateEventScreenState extends State<UpdateEventScreen> {
  ...
  void initState() {
    ...
    _cropTypeController = TextEditingController(text: widget.event.cropType ?? '');
    _cropVarietyController = TextEditingController(text: widget.event.cropVariety ?? '');
    _fieldLocationController = TextEditingController(text: widget.event.fieldLocation ?? '');
    ...
    _reminders = widget.event.reminders.map((r) {
      return {
  ...
  void _saveChanges() {
    ...
    final updatedEvent = eventModel.Event.create(
      ...
      reminders: remindersJson.map((r) => eventModel.Reminder.fromJson(r)).toList(),
    );
